<div class="d-flex p-fixed flex-column flex-shrink-0 p-3 bg-dark text-light shadow-lg d-none d-lg-flex" style="width: 280px; height:100vh; z-index:10;" id="sidebar">
    ...
    <div class="dropdown text-center">
        <a href="#" class="w-full align-items-center link-light text-decoration-none me-3" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="../uploads/<?php echo userinfo($conn,$_SESSION['user_ID'])['profile'] ?>" alt="" width="80" height="80" class="rounded-circle me-2"><br>
            <strong  style=" font-size:25px; "> <?php echo userinfo($conn, $_SESSION['user_ID'])['u_username']; ?></strong>
        </a>
    ...
    <li>
            <a href="schedule.php" class="nav-link link-light <?php if ($page == 'Schedules'){echo 'active text-light';} ?>">
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 10h16m-8-3V4M7 7V4m10 3V4M5 20h14a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1Zm3-7h.01v.01H8V13Zm4 0h.01v.01H12V13Zm4 0h.01v.01H16V13Zm-8 4h.01v.01H8V17Zm4 0h.01v.01H12V17Zm4 0h.01v.01H16V17Z"/>
        ...
        <li>
            <a href="appointment.php" class="nav-link link-light <?php if ($page == 'Appointment'){echo 'active text-light';} ?>">
