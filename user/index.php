...
<head>
    <meta charset="UTF-8">
    <title>Two Equal Parts with Flexbox</title>
...
<body>
    <div class="contain">
        ...
        <div class="right">
            ...
            <h2 class="mb-3" style="color:whitesmoke">SIGN IN</h2>
...
<button type="submit" class="btn btn-danger px-4 mb-3" id="btnlogin"> SIGN IN</button>
