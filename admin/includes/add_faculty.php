...
if(empty($cpass)){
  ...
  $errorCpass=true;
    ...
    add_faculty($fname, $mname, $lname, $address,$gender,$contact,$bday, $pass, $email, $conn);
    ...
    Swal.fire({
        title: 'Success!',
        text: 'Faculty member account has been successfully created.',
        icon: 'success',
...
<script>
    ...
    if(errorEmpty == false && errorEmail == false && errorCpass == false && errorExist == false && errorContact == false){
        $("#fname,#mname,#lname,#bday,#email,#contact,#address,#pass,#cpass").val("");
    }
