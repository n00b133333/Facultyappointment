...
<script>
  $(document).ready(function () {
    ...
    $("form").submit(function (event) {
      ...
      formData.append("id", <?php echo $_SESSION['faculty_ID'] ?>);
...
if(userinfo($conn,$_SESSION['faculty_ID'])['gender']  == "Male"){
    echo "<option value='Male' selected>Male</option>
    <option value='Female'>Female</option>";
}
else if (userinfo($conn,$_SESSION['faculty_ID'])['gender'] == "Female"){
