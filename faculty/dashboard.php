...
$schedules = $conn->query("SELECT * FROM `appointments` INNER JOIN faculty ON appointments.faculty_ID = faculty.faculty_ID WHERE faculty.faculty_ID = $faculty_id AND status = 1");
$sched_res = [];
